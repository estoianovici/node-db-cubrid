...
v8::Persistent<v8::FunctionTemplate> node_db_cubrid::Query::constructorTemplate;

void node_db_cubrid::Query::Init(v8::Handle<v8::Object> target) {
...
v8::Handle<v8::Value> node_db_cubrid::Query::New(const v8::Arguments& args) {
	v8::HandleScope scope;

	node_db_cubrid::Query* query = new node_db_cubrid::Query();
	if (query == NULL) {

/*!
 * Copyright by Eugen Stoianovici
 *
...
try {
    binding = require("./build/default/cubrid_bindings");
} catch(error) {
    binding = require("./build/Release/cubrid_bindings");
}
...
exports.Database = extend(binding.Cubrid, BaseEventEmitter);
